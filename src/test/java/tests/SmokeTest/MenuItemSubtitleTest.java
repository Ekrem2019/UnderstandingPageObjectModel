...
public class MenuItemSubtitleTest  extends TestBase {
    ...
    public void menuItemTest(String menuItem, String pageSustitle){
        LoginPage loginPage = new LoginPage();
        loginPage.login();
        loginPage.menuNavigation(menuItem);
        String expectedTitle = pageSustitle;
        String actualTitle = loginPage.getPageSubtitle();
        Assert.assertEquals(actualTitle,expectedTitle,menuItem+" Page sustitle is wrong");
    }

//    @Test(description = "verify that page sustitle is correct for activity stream")
//    public void  test1(){
//        LoginPage loginPage = new LoginPage();
//        loginPage.login();
...
//        String actualTitle = loginPage.getPageSubtitle();
//        Assert.assertEquals(actualTitle,expectedTitle,"Activity Stream page subtitle is wrong");
//    }
//    @Test(description = "verify that page sustitle is correct for Tasks")
//    public void test2(){
//        LoginPage loginPage = new LoginPage();
//        loginPage.login();
